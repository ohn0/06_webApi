    ...
    private void connect(boolean isTemple) {
        ...
        try {
            ...
            try {
                ...
                String url = "jdbc:mysql://localhost:3307/FA17_3344_1_tug03013?user=tug03013&password=yehohghi";

                // unless you are working from temple (wachman hall)
                if (isTemple) {
                    url = "jdbc:mysql://cis-linux2.temple.edu:3306/FA17_3344_1_tug03013?user=tug03013&password=yehohghi";
                }
